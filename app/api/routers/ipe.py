...
ParametroDataInicio = Annotated[
    BrazilianDate | None,
    Query(description="Data inicial do evento no formato brasileiro (DD/MM/AAAA).", examples=["01/01/2025"]),
]
ParametroDataFim = Annotated[
    BrazilianDate | None,
    Query(description="Data final do evento no formato brasileiro (DD/MM/AAAA).", examples=["31/12/2025"]),
]

...
- **Typed Staging** means rebuildable PostgreSQL staging tables loaded from normalized artifacts via `COPY`, rather than the generic JSON-heavy `ingestion_rows` path.
